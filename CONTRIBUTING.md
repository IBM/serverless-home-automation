...
repository](https://github.com/IBM/serverless-home-automation).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/serverless-home-automation/issues). Before embarking on 
...
issue](https://github.com/IBM/serverless-home-automation/issues) before sending a pull
...
(https://github.com/IBM/serverless-home-automation/issues).
